...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_btn.setText(getResources().getString(R.string.search_go));
		...
		{
			img.setImageResource(R.drawable.picture_frame);
		}
	...
	public void setUpStatusLabel()
	{
		...
		if( Parent._tv == null )
		{
			...
			Parent._tv.setText(R.string.selectTextMode);
	...
	public void showScreenKeyboard(final String oldText, boolean sendBackspace)
	{
		...
		_screenKeyboard.setOnKeyListener((android.view.View.OnKeyListener) new myKeyListener(this, sendBackspace));
		_screenKeyboard.setHint(R.string.VideoView_error_text_invalid_progressive_playback);
	...
	*/
	...
	public void showTaskbarNotification(String text0, String text1, String text2)
	{
		...
		Notification n = new Notification(R.drawable.ic_dialog_alert, text0, System.currentTimeMillis());
