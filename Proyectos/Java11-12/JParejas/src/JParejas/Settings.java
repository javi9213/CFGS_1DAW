...
// too much code here, split into multiple files, possibly auto-generated menus?
class Settings
{
		...
		try {
			...
			if( cfgVersion < p.getApplicationVersion() )
			{
				...
				if( Globals.ResetSdlConfigForThisVersion )
				{
					...
					settingsFile.close();
					ObjectOutputStream out = new ObjectOutputStream(p.openFileOutput( SettingsFileName, Context.MODE_WORLD_READABLE ));
					out.writeInt(-1);
					out.close();
		...
		if( !Globals.BrokenLibCMessageShown )
		{
			...
			try {
				...
				if( (new ProcessBuilder().command(path).start()).waitFor() != 42 )
				{
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(p);
					builder.setTitle(p.getResources().getString(R.string.dialog_alert_title));
					builder.setMessage(p.getResources().getString(R.string.dialog_alert_title));
	...
	static class MainMenu extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.defaultMsisdnAlphaTag);
		}
		void run (final MainActivity p)
		{
			Menu options[] =
	...
	static class MouseConfigMainMenu extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback);
		}
		boolean enabled()
		{
	...
	static class KeyboardConfigMainMenu extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.copyUrl);
		}
		boolean enabled()
		{
	...
	static class DownloadConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.search_go);
		}
		void run (final MainActivity p)
		{
			long freeSdcard = 0;
			...
			final CharSequence[] items = { p.getResources().getString(R.string.emptyPhoneNumber, freePhone),
											p.getResources().getString(R.string.selectTextMode, freeSdcard),
											p.getResources().getString(R.string.selectAll) };
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.selectTextMode));
		...
		{
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.selectAll));
		...
		{
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.VideoView_error_button));
	...
	static class OptionalDownloadConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.ok));
			...
			if( firstStart )
			{
				builder.setNegativeButton(p.getResources().getString(R.string.untitled), new DialogInterface.OnClickListener()
				{
					public void onClick(DialogInterface dialog, int item) 
					{
						dialog.dismiss();
	...
	static class AdditionalInputConfig extends Menu
	{
		...
		{
			CharSequence[] items = {
				p.getResources().getString(R.string.copyUrl),
				p.getResources().getString(R.string.dialog_alert_title)
			};
	...
	static class AccelerometerConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.httpErrorUnsupportedScheme);
		}
		boolean enabled()
		{
		...
		void run (final MainActivity p)
		{
			...
			final CharSequence[] items = { p.getResources().getString(R.string.copyUrl),
											p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
											p.getResources().getString(R.string.yes) };

			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.no);
		...
		static void showAccelerometerCenterConfig(final MainActivity p)
		{
			...
			final CharSequence[] items = { p.getResources().getString(R.string.paste),
											p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
											p.getResources().getString(R.string.search_go) };
	...
	static class ScreenKeyboardSizeConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.VideoView_error_button);
		}
		void run (final MainActivity p)
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.defaultMsisdnAlphaTag),
											p.getResources().getString(R.string.dialog_alert_title),
											p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
											p.getResources().getString(R.string.copyUrl) };
	...
	static class ScreenKeyboardDrawSizeConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.httpErrorUnsupportedScheme));
	...
	static class ScreenKeyboardThemeConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.copy);
		}
		void run (final MainActivity p)
		{
			final CharSequence[] items = {
				p.getResources().getString(R.string.paste, "Ultimate Droid", "Sean Stieber"),
				p.getResources().getString(R.string.paste, "Simple Theme", "Beholder"),
				p.getResources().getString(R.string.paste, "Sun", "Sirea")
				};

			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.copy));
	...
	static class ScreenKeyboardTransparencyConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.defaultVoiceMailAlphaTag);
		}
		void run (final MainActivity p)
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.status_bar_notification_info_overflow),
											p.getResources().getString(R.string.status_bar_notification_info_overflow),
											p.getResources().getString(R.string.status_bar_notification_info_overflow),
											p.getResources().getString(R.string.status_bar_notification_info_overflow),
											p.getResources().getString(R.string.status_bar_notification_info_overflow) };

			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.defaultVoiceMailAlphaTag));
	...
	static class AudioConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback),
											p.getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback),
											p.getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback),
											p.getResources().getString(R.string.VideoView_error_text_invalid_progressive_playback) };

			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.defaultMsisdnAlphaTag);
	...
	static class DisplaySizeConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			CharSequence[] items = {
										p.getResources().getString(R.string.selectAll),
										p.getResources().getString(R.string.selectTextMode),
										p.getResources().getString(R.string.selectAll),
										p.getResources().getString(R.string.selectTextMode),
										p.getResources().getString(R.string.selectAll),
									};
			...
			if( firstStart )
			{
				CharSequence[] items2 = {
											...
											p.getResources().getString(R.string.selectTextMode),
											p.getResources().getString(R.string.selectAll),
											p.getResources().getString(R.string.untitled),
										};
				items = items2;
				if( ! Globals.SwVideoMode )
				{
	...
	static class LeftClickConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.VideoView_error_button),
											p.getResources().getString(R.string.VideoView_error_button),
											p.getResources().getString(R.string.VideoView_error_button),
											p.getResources().getString(R.string.VideoView_error_button),
											p.getResources().getString(R.string.VideoView_error_button),
											p.getResources().getString(R.string.VideoView_error_button),
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.VideoView_error_button);
		...
		static void showLeftClickTimeoutConfig(final MainActivity p) {
			final CharSequence[] items = {	p.getResources().getString(R.string.copy),
											p.getResources().getString(R.string.copy),
											p.getResources().getString(R.string.copy),
											p.getResources().getString(R.string.copy),
											p.getResources().getString(R.string.copy) };
	...
	static class RightClickConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.copyUrl);
	...
	public static class KeyRemapToolMouseClick implements KeyEventsListener
	{
		...
		{
			p = _p;
			p.setText(p.getResources().getString(R.string.status_bar_notification_info_overflow));
	...
	static class AdditionalMouseConfig extends Menu
	{
		...
		{
			CharSequence[] items = {
				p.getResources().getString(R.string.defaultMsisdnAlphaTag),
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.defaultMsisdnAlphaTag));
			builder.setMultiChoiceItems(items, defaults, new DialogInterface.OnMultiChoiceClickListener()
			{
				public void onClick(DialogInterface dialog, int item, boolean isChecked) 
				{
		...
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.cancel),
											p.getResources().getString(R.string.yes),
											p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
											p.getResources().getString(R.string.copyUrl),
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.emptyPhoneNumber);
		...
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.no),
											p.getResources().getString(R.string.yes),
											p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
											p.getResources().getString(R.string.copyUrl) };
	...
	static class ArrowKeysConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.cut);
		}
		boolean enabled()
		{
		...
		void run (final MainActivity p)
		{
			final CharSequence[] items = { p.getResources().getString(R.string.search_go),
											p.getResources().getString(R.string.search_go),
											p.getResources().getString(R.string.search_go) };

			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.cut));
	...
	static class JoystickMouseConfig extends Menu
	{
		...
		void run (final MainActivity p)
		{
			final CharSequence[] items = {	p.getResources().getString(R.string.yes),
	...
	static class RemapHwKeysConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.dialog_alert_title);
		}
		...
		public static class KeyRemapTool implements KeyEventsListener
		{
			...
			public void onKeyEvent(final int keyCode)
			{
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(p);
				builder.setTitle(R.string.paste);
	...
	static class RemapScreenKbConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.selectAll);
		}
		//boolean enabled() { return true; };
		void run (final MainActivity p)
		{
			CharSequence[] items = {
				p.getResources().getString(R.string.cut),
				p.getResources().getString(R.string.VideoView_error_text_unknown),
				p.getResources().getString(R.string.VideoView_error_button) + " 1",
				p.getResources().getString(R.string.VideoView_error_button) + " 2",
				p.getResources().getString(R.string.VideoView_error_button) + " 3",
				p.getResources().getString(R.string.VideoView_error_button) + " 4",
				p.getResources().getString(R.string.VideoView_error_button) + " 5",
				p.getResources().getString(R.string.VideoView_error_button) + " 6",
			};
	...
	static class ScreenGesturesConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.status_bar_notification_info_overflow);
		}
		//boolean enabled() { return true; };
		void run (final MainActivity p)
		{
			CharSequence[] items = {
				...
				p.getResources().getString(R.string.defaultVoiceMailAlphaTag),
				p.getResources().getString(R.string.dialog_alert_title),
				p.getResources().getString(R.string.emptyPhoneNumber),
			};
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.status_bar_notification_info_overflow));
			builder.setMultiChoiceItems(items, defaults, new DialogInterface.OnMultiChoiceClickListener() 
			{
				public void onClick(DialogInterface dialog, int item, boolean isChecked) 
				{
		...
		static void showScreenGesturesConfig2(final MainActivity p)
		{
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(R.string.httpErrorUnsupportedScheme);
	...
	static class CalibrateTouchscreenMenu extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.yes);
		}
		//boolean enabled() { return true; };
		void run (final MainActivity p)
		{
			p.setText(p.getResources().getString(R.string.yes));
		...
		static class ScreenEdgesCalibrationTool implements TouchEventsListener, KeyEventsListener
		{
			...
			public ScreenEdgesCalibrationTool(MainActivity _p) 
			{
				...
				bmp = BitmapFactory.decodeResource( p.getResources(), R.drawable.edit_text );
	...
	static class CustomizeScreenKbLayout extends Menu
	{
		...
		void run (final MainActivity p)
		{
			p.setText(p.getResources().getString(R.string.dialog_alert_title));
	...
	static class VideoSettingsConfig extends Menu
	{
		String title(final MainActivity p)
		{
			return p.getResources().getString(R.string.VideoView_error_title);
		}
		//boolean enabled() { return true; };
		void run (final MainActivity p)
		{
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(p);
			builder.setTitle(p.getResources().getString(R.string.VideoView_error_title));
			builder.setMultiChoiceItems(items, defaults, new DialogInterface.OnMultiChoiceClickListener() 
			{
				public void onClick(DialogInterface dialog, int item, boolean isChecked) 
				{
	...
	static void Apply(Activity p)
	{
		...
		// get current user name and set envvar USER, the API is not availalbe on Android 1.6 so I don't bother with this
	}
	...
	static void SetupTouchscreenKeyboardGraphics(Activity p)
	{
		if( Globals.UseTouchscreenKeyboard )
		{
			...
			if( Globals.TouchscreenKeyboardTheme == 0 )
			{
				nativeSetupScreenKeyboardButtons(loadRaw(p, R.integer.status_bar_notification_info_maxnum));
			}
